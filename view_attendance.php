...
<body>
  <div class="dashboard">
    ...
    <div class="back-links">
      <a href="dashboard_admin.php?branch_id=<?php echo urlencode($student['branch_id']); ?>"><button>⬅ Back to Branch Dashboard</button></a>
      <a href="dashboard_admin.php"><button>⬅ Back to Admin Dashboard</button></a>
    </div>
  </div>
</body>
</html>
